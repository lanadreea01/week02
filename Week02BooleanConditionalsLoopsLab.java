...
public class Week02BooleanConditionalsLoopsLab {
	...
	public static void main(String[] args) {
		...
		//				iv. If there are 5 or more cookies, print "Jackpot!"
           ...
           int numberOfChilderen = 2;
		  
		if(numberOfCookies % numberOfChilderen > 5) {
        	  System.out.println("Jackpot!");
           } else if (numberOfCookies % numberOfChilderen >= 2) {
        	   System.out.println("whoohoooo!");
           } else if  (numberOfCookies % numberOfChilderen > 0) {
